                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="grading-item mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="3"
                                            placeholder="Nhập nhận xét cho câu 1...">Giải thích rõ ràng về sự khác biệt giữa Flexbox và Grid. Tuy nhiên, có thể thêm ví dụ code cụ thể để minh họa.</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="grading-item mb-4">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Điểm số (tối đa: 5)</label>
                                        <input type="number" class="form-control" min="0" max="5" step="0.5" value="4">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Nhận xét</label>
                                        <textarea class="form-control" rows="3"
                                            placeholder="Nhập nhận xét cho câu 2...">Trình bày tốt về cách sử dụng Grid. Code ví dụ rõ ràng và dễ hiểu.</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="grading-item">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="4"
                                            placeholder="Nhập nhận xét tổng quan...">Bài làm tốt, thể hiện hiểu biết sâu về CSS Grid và Flexbox. Cần bổ sung thêm ví dụ thực tế để minh họa rõ hơn.</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Góp ý cải thiện</label>
                                        <textarea class="form-control" rows="3"
                                            placeholder="Nhập góp ý để học viên cải thiện...">Nên thêm các ví dụ code cụ thể và giải thích chi tiết hơn về các trường hợp sử dụng thực tế.</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
