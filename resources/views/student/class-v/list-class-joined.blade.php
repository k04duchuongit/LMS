                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                ...
                                <span class="badge bg-primary badge-progress">75%</span>
                            </div>
                            <div class="progress">
                ...
                <div class="card course-card border-0 shadow-sm h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <small class="text-muted">Tiến độ học tập</small>
                                <span class="badge bg-success badge-progress">100%</span>
                            </div>
                            <div class="progress">
                ...
                <div class="card course-card border-0 shadow-sm h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <small class="text-muted">Tiến độ học tập</small>
                                <span class="badge bg-warning badge-progress">25%</span>
                            </div>
                            <div class="progress">
                        ...
                        <div class="mt-3">
                            <a href="joinedClass.html" class="btn btn-primary w-100">
                                <i class="fas fa-play-circle me-2"></i>Tiếp tục học
                            </a>
                        </div>
                    </div>
